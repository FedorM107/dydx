...
class BotAgent:
    ...
    def open_trades(self):
        ...
        print(f"Side: {self.base_side}, Size: {self.base_size}, Prize: {self.base_price}")
        print("---")
        ...
        print(f"Side: {self.quote_side}, Size: {self.quote_size}, Prize: {self.quote_price}")
        print("---")
