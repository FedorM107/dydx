...
def manage_trade_exits(client):
    ...
    Based upon critiria set in constants
    """

    #Initializing saving output
    save_output = []
    ...
    for position in open_positions_dict:
        ...
        #Initialize is close trigger
        is_close = False

        #Extract position matching from file - market_1
        position_market_m1 = position["market_1"]
        position_size_m1 = position["order_m1_size"]
        position_side_m1 = position["order_m1_side"]

        #Extract position matching from file - market_2
        ...
        check_m1 = position_market_m1 == order_market_m1 and str(float(position_size_m1)) == str(float(order_size_m1)) and position_side_m1 == order_side_m1
        check_m2 = position_market_m2 == order_market_m2 and str(float(position_size_m2)) == str(float(order_size_m2)) and position_side_m2 == order_side_m2
        ...
        #Get markets for reference of tick size (Consider making sure that you really got data here)
        ...
        ###
        #Ad any other close logic you want here
        #Trigger is_close
        ###
